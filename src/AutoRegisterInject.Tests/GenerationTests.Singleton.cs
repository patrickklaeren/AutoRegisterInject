...
{
    [Fact]
    public async Task ShouldRegisterSingleton()
    {
        const string INPUT = @"[RegisterSingleton]
public class Foo { }";
...
public static class AutoRegisterInjectServiceCollectionExtension
{
    ...
    [Fact]
    public async Task ShouldRegisterSingletonNoInterface()
    {
        const string INPUT = @"[RegisterSingletonNoInterface]
...
public static class AutoRegisterInjectServiceCollectionExtension
{
    ...
    [Fact]
    public async Task ShouldRegisterSingletonFromInterface()
    {
        const string INPUT = @"[RegisterSingleton]
public class Foo : IFoo { }
public interface IFoo { }
