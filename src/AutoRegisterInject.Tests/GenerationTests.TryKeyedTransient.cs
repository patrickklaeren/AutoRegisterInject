...
{
    [Fact]
    public async Task ShouldTryRegisterKeyedTransient()
    {
        const string INPUT = @"[TryRegisterKeyedTransient(serviceKey: ""BazKey"")]
public class Foo { }";
...
public static class AutoRegisterInjectServiceCollectionExtension
{
    ...
    {
        serviceCollection.TryAddKeyedTransient<Foo>(""BazKey"");
    ...
    [Fact]
    public async Task ShouldTryRegisterKeyedTransientFromInterface()
    {
        const string INPUT = @"[TryRegisterKeyedTransient(serviceKey: ""BazKey"")]
...
public static class AutoRegisterInjectServiceCollectionExtension
{
    ...
    internal static Microsoft.Extensions.DependencyInjection.IServiceCollection AutoRegister(this Microsoft.Extensions.DependencyInjection.IServiceCollection serviceCollection)
    {
        serviceCollection.TryAddKeyedTransient<IFoo, Foo>(""BazKey"");
        return serviceCollection;
    }
}";
